  ...
  return (
    <div className="hidden sm:flex flex-col items-center xl:items-start xl:w-[340px] p-2 fixed h-full">
      ...
      <div className="text-[#d9d9d9] flex items-center justify-center mt-auto hoverAnimation xl:ml-auto xl:-mr-5">
        <img src="https://yt3.ggpht.com/yti/APfAmoHa-qYPte7NRc5YAqRdoO9XBGYze97iqDM1sg=s88-c-k-c0x00ffffff-no-rj-mo" alt=""
        className="h-10 w-10 rounded-full xl:mr-2.5 "
        />
        <div className="hidden xl:inline leading-5">
          <h4 className="font-bold">Daniel Dulgerian</h4>
          <p className="text-[#6e767d]">@DandleGarian</p>
        </div>
